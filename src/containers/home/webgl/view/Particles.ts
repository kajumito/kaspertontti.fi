...
class Particles {
  ...
  drawPoints() {
    ...
    geometry.addAttribute('pindex', new InstancedBufferAttribute(indices, 1))
    geometry.addAttribute('offset', new InstancedBufferAttribute(offsets, 3))
    geometry.addAttribute('angle', new InstancedBufferAttribute(angles, 1))
  ...
  show(time = 1.0) {
    ...
    TweenLite.to(this.objectMesh.material.uniforms.uRandom, time, {
      value: 1.0,
    })
    TweenLite.fromTo(
  ...
  hide(time = 0.5) {
    ...
    TweenLite.to(this.objectMesh.material.uniforms.uDepth, time, {
      value: 40.0,
      ease: Power1.easeIn,
    })
    TweenLite.to(this.objectMesh.material.uniforms.uSize, time * 1.2, {
      value: 0.0,
    })
  }
